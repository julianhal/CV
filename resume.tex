...
%     Profile
%--------------------------------------------------------------
\newcommand{\yourName}{Julian Halsøy}
% How you want it to show up on the resume
\newcommand{\yourWebsite}{julianhal.no}
% vs how you want it to show up. If it's the same you can just replace "\yourWebsiteLink" with "yourWebsite"
\newcommand{\yourWebsiteLink}{julianhal.no}
\newcommand{\yourEmail}{julian.halsoy@gmail.com}
\newcommand{\yourPhone}{483 58 815}
\newcommand{\githubUserName}{julianhal}
